...
<div id="page-stage" class="container-xxl py-5">
    <section style="height: 80px;margin-top: -80px;"></section>
    <section id="sabriter" class="row">
        <div class="col-md-6">
            <img class="img-fluid" src="assets/img/sabriter.png" alt="">
        </div>
    ...
    <section id="cueillir"  class="row">
        <div class="col-md-6 order-first order-md-2">
            <img class="img-fluid" src="assets/img/cueillette.png" alt="">
        </div>
        <div class="col-md-6 text-stage">
            <h2>Cueillir</h2>
    ...
    <section id="faire-un-feu" class="row">
        <div class="col-md-6">
            <img class="img-fluid" src="assets/img/faire-un-feu.png" alt="">
        </div>
        <div class="col-md-6 text-stage">
            <h2>Faire un feu</h2>
    ...
    <section id="cuisine-sauvage" class="row">
        <div class="col-md-6 order-first order-md-2">
            <img class="img-fluid" src="assets/img/stage4.png" alt="">
        </div>
        <div class="col-md-6 text-stage">
    ...
    <section id="le-groupe" class="row">
        <div class="col-md-6">
            <img class="img-fluid" src="assets/img/le-groupe.png" alt="">
        </div>
        <div class="col-md-6 text-stage">
            <h2>Le groupe</h2>
    ...
    <section id="legerete" class="row">
        <div class="col-md-6 order-first order-md-2">
            <img class="img-fluid" src="assets/img/legerete.png" alt="">
        </div>
        <div class="col-md-6 text-stage">
            <h2>Légèreté</h2>
    ...
    <section id="itinerance" class="row">
        <div class="col-md-6">
            <img class="img-fluid" src="assets/img/itinerance.png" alt="">
        </div>
        <div class="col-md-6 text-stage">
            <h2>Itinérance</h2>
    ...
    <section id="ecologie-sensible" class="row">
        <div class="col-md-6 order-first order-md-2">
            <img class="img-fluid" src="assets/img/ecologie-sensible.png" alt="">
        </div>
        <div class="col-md-6 text-stage">
